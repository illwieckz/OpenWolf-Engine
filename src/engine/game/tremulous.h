...
#define ADM(d)                      ((S32)((F32)d*ALIEN_WDMG_MODIFIER))
...
#define AHM(h)                      ((S32)((F32)h*ALIEN_HLTH_MODIFIER))

#define ALIEN_VALUE_MODIFIER        1.2f
#define AVM(h)                      ((S32)((F32)h*ALIEN_VALUE_MODIFIER))
...
#define ABHM(h)                     ((S32)((F32)h*ALIEN_BHLTH_MODIFIER))
#define ALIEN_BVALUE_MODIFIER       30.0f
#define ABVM(h)                     ((S32)((F32)h*ALIEN_BVALUE_MODIFIER))
...
#define HDM(d)                      ((S32)((F32)d*HUMAN_WDMG_MODIFIER))
...
#define HBHM(h)                     ((S32)((F32)h*HUMAN_BHLTH_MODIFIER))
#define HUMAN_BVALUE_MODIFIER       80.0f
#define HBVM(h)                     ((S32)((F32)h*(F32)HUMAN_BVALUE_MODIFIER)) // remember these are measured in credits not frags (c.f. ALIEN_CREDITS_PER_FRAG)
