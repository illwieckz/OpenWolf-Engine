...
set(OVR_ROOT_DIR
	"${OVR_ROOT_DIR}"
	${LIB_DIR}/OculusSDK_0.5/OculusSDK
	CACHE
	PATH
...
find_library(OVR_LIBRARY_RELEASE
	...
	${LIB_DIR}/OculusSDK_0.5/OculusSDK/LibOVR/Lib
	${LIB_DIR}/OculusSDK_0.5/OculusSDK/LibOVR
	${LIB_DIR}/OculusSDK_0.5/OculusSDK/LibOVR/Lib/Windows/x64/Release/VS2010
	PATH_SUFFIXES
...
find_path(OVR_INCLUDE_DIR
	...
	PATHS
	"${OVR_ROOT_DIR}"
	${LIB_DIR}/OculusSDK_0.5/OculusSDK/LibOVR/Include
	PATH_SUFFIXES
	include
	Include
	)
...
MESSAGE("OVR_LIBRARIES is ${OVR_LIBRARY}")
MESSAGE("OVR_INCLUDE_DIRS is ${OVR_INCLUDE_DIR}")
