...
FIND_PATH(GMP_INCLUDE_DIR gmp.h
  ...
  /usr/include
  /opt/local/include
  ${LIB_DIR}/mpir/include
)

SET(GMP_NAMES gmp mpir)
FIND_LIBRARY(GMP_LIBRARY
  NAMES ${GMP_NAMES}
  PATHS /usr/lib /usr/local/lib /opt/local/lib ${LIB_DIR}/mpir/libs/win64/ ${LIB_DIR}/mpir/libs/win32/
)
...
MESSAGE("GMP_INCLUDE_DIR is ${GMP_INCLUDE_DIR}")
MESSAGE("GMP_LIBRARY is ${GMP_LIBRARY}")
