...
** Write to file
*/
static U64 DL_cb_FWriteFile( void* ptr, U64 size, U64 nmemb, void* stream )
{
...
** Print progress
*/
static int DL_cb_Progress( void* clientp, F64 dltotal, F64 dlnow, F64 ultotal, F64 ulnow )
{
...
===============
*/
int DL_BeginDownload( StringEntry localName, StringEntry remoteName, int debug )
{
