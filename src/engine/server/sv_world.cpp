...
===============
*/
worldSector_t*  SV_CreateworldSector( S32 depth, vec3_t mins, vec3_t maxs )
{
    worldSector_t*  anode;
...
void SV_ClipMoveToEntities( moveclip_t* clip )
{
    ...
    for( i = 0; i < num; i++ )
    {
        ...
        collisionModelManager->TransformedBoxTrace( &trace, ( F32* )clip->start, ( F32* )clip->end, ( F32* )clip->mins, ( F32* )clip->maxs, clipHandle, clip->contentmask, origin, angles, clip->collisionType );
