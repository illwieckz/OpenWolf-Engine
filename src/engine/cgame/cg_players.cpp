...
UTF8* cg_customSoundNames[ MAX_CUSTOM_SOUNDS ] =
{
    "*death1.wav",
    "*death2.wav",
    "*death3.wav",
...
/*
================
idCGameLocal::CustomSound
================
*/
sfxHandle_t idCGameLocal::CustomSound( S32 clientNum, StringEntry soundName )
{
    clientInfo_t*  ci;
    S32           i;
...
======================
*/
bool idCGameLocal::ParseAnimationFile( StringEntry filename, clientInfo_t* ci )
{
    UTF8*          text_p, *prev;
    S32           len;
    S32           i;
...
/*
==========================
idCGameLocal::RegisterClientSkin
==========================
*/
bool idCGameLocal::RegisterClientSkin( clientInfo_t* ci, StringEntry modelName, StringEntry skinName )
{
...
/*
==========================
idCGameLocal::RegisterClientModelname
==========================
*/
bool idCGameLocal::RegisterClientModelname( clientInfo_t* ci, StringEntry modelName, StringEntry skinName )
{
    UTF8 filename[ MAX_QPATH * 2 ];
...
/*
====================
idCGameLocal::ColorFromString
====================
*/
void idCGameLocal::ColorFromString( StringEntry v, vec3_t color )
{
    S32 val;
...
===================
*/
void idCGameLocal::LoadClientInfo( clientInfo_t* ci )
{
    StringEntry  dir;
    S32         i;
    StringEntry  s;
    ...
    for( i = 0; i < MAX_CUSTOM_SOUNDS; i++ )
    {
        ...
        if( !FileExists( va( "sound/player/%s/%s", dir, s + 1 ) ) )
        {
            //file doesn't exist
...
/*
======================
idCGameLocal::CopyClientInfoModel
======================
*/
void idCGameLocal::CopyClientInfoModel( clientInfo_t* from, clientInfo_t* to )
{
...
======================
*/
S32 idCGameLocal::GetCorpseNum( class_t _class )
{
    S32           i;
    clientInfo_t*  match;
    UTF8*          modelName;
...
/*
======================
idCGameLocal::ScanForExistingClientInfo
======================
*/
bool idCGameLocal::ScanForExistingClientInfo( clientInfo_t* ci )
{
    S32   i;
    clientInfo_t*  match;
...
/*
======================
idCGameLocal::PrecacheClientInfo
======================
*/
void idCGameLocal::PrecacheClientInfo( class_t _class, UTF8* model, UTF8* skin )
{
    clientInfo_t*  ci;
...
/*
=============
idCGameLocal::TeamJoinMessage

Prints messages when players change teams
=============
*/
void idCGameLocal::TeamJoinMessage( clientInfo_t* newInfo, clientInfo_t* ci )
{
    S32  team;
    S32  oldteam;
    UTF8* playerName;
...
======================
*/
void idCGameLocal::NewClientInfo( S32 clientNum )
{
    clientInfo_t*  ci;
    clientInfo_t  newInfo;
    StringEntry    configstring;
    StringEntry    v;
    UTF8*          slash;
    
    ci = &cgs.clientinfo[ clientNum ];
    
    configstring = ConfigString( clientNum + CS_PLAYERS );
    if( !configstring[ 0 ] )
    {
...
/*
===============
idCGameLocal::SetLerpFrameAnimation

may include ANIM_TOGGLEBIT
===============
*/
void idCGameLocal::SetLerpFrameAnimation( clientInfo_t* ci, lerpFrame_t* lf, S32 newAnimation )
{
    animation_t* anim;
...
/*
===============
idCGameLocal::RunPlayerLerpFrame

Sets cg.snap, cg.oldFrame, and cg.backlerp
cg.time should be between oldFrameTime and frameTime after exit
===============
*/
void idCGameLocal::RunPlayerLerpFrame( clientInfo_t* ci, lerpFrame_t* lf, S32 newAnimation, F32 speedScale )
{
    S32         f, numFrames;
    animation_t* anim;
    ...
    if( lf->frameTime == lf->oldFrameTime )
        ...
        lf->backlerp = 1.0 - ( F32 )( cg.time - lf->oldFrameTime ) / ( lf->frameTime - lf->oldFrameTime );
}


/*
===============
idCGameLocal::ClearLerpFrame
===============
*/
void idCGameLocal::ClearLerpFrame( clientInfo_t* ci, lerpFrame_t* lf, S32 animationNumber )
{
...
/*
===============
idCGameLocal::PlayerAnimation
===============
*/
void idCGameLocal::PlayerAnimation( centity_t* cent, S32* legsOld, S32* legs, F32* legsBackLerp, S32* torsoOld, S32* torso, F32* torsoBackLerp )
{
    clientInfo_t*  ci;
    S32           clientNum;
    F32         speedScale = 1.0f;
...
/*
===============
idCGameLocal::PlayerNonSegAnimation
===============
*/
void idCGameLocal::PlayerNonSegAnimation( centity_t* cent, S32* nonSegOld, S32* nonSeg, F32* nonSegBackLerp )
{
    clientInfo_t*  ci;
    S32           clientNum;
    F32         speedScale = 1.0f;
...
/*
==================
idCGameLocal::SwingAngles
==================
*/
void idCGameLocal::SwingAngles( F32 destination, F32 swingTolerance, F32 clampTolerance, F32 speed, F32* angle, bool* swinging )
{
    F32 swing, move, scale;
...
/*
=================
idCGameLocal::AddPainTwitch
=================
*/
void idCGameLocal::AddPainTwitch( centity_t* cent, vec3_t torsoAngles )
{
    S32 t;
    F32 f;
...
===============
*/
void idCGameLocal::PlayerAngles( centity_t* cent, vec3_t srcAngles, vec3_t legs[ 3 ], vec3_t torso[ 3 ], vec3_t head[ 3 ] )
{
    vec3_t        legsAngles, torsoAngles, headAngles;
    F32         dest;
    static S32    movementOffsets[ 8 ] = { 0, 22, 45, -22, 0, 22, -45, -22 };
    vec3_t        velocity;
    F32         speed;
    S32           dir, clientNum;
    clientInfo_t*  ci;
...
/*
===============
idCGameLocal::PlayerWWSmoothing

Smooth the angles of transitioning wall walkers
===============
*/
void idCGameLocal::PlayerWWSmoothing( centity_t* cent, vec3_t in[ 3 ], vec3_t out[ 3 ] )
{
    ...
    F32         stLocal, sFraction, rotAngle;
...
/*
===============
idCGameLocal::PlayerNonSegAngles

Resolve angles for non-segmented models
===============
*/
void idCGameLocal::PlayerNonSegAngles( centity_t* cent, vec3_t srcAngles, vec3_t nonSegAxis[ 3 ] )
{
    vec3_t        localAngles;
    vec3_t        velocity;
    F32         speed;
...
/*
===============
idCGameLocal::PlayerUpgrade
===============
*/
void idCGameLocal::PlayerUpgrades( centity_t* cent, refEntity_t* torso )
{
    S32           held, active;
    refEntity_t   jetpack;
    ...
    if( held & ( 1 << UP_JETPACK ) )
    {
        ...
        PositionRotatedEntityOnTag( &jetpack, torso, torso->hModel, "tag_head" );
        ...
        if( active & ( 1 << UP_JETPACK ) )
        {
            if( es->pos.trDelta[ 2 ] > 10.0f )
            {
                ...
                {
                    if( IsParticleSystemValid( &cent->jetPackPS ) )
                        DestroyParticleSystem( &cent->jetPackPS );
                        
                    cent->jetPackPS = SpawnNewParticleSystem( cgs.media.jetPackAscendPS );
            ...
            else if( es->pos.trDelta[ 2 ] < -10.0f )
            {
                if( cent->jetPackState != JPS_DESCENDING )
                {
                    ...
                    cent->jetPackPS = SpawnNewParticleSystem( cgs.media.jetPackDescendPS );
            ...
            else
            {
                if( cent->jetPackState != JPS_HOVERING )
                {
                    ...
                    cent->jetPackPS = SpawnNewParticleSystem( cgs.media.jetPackHoverPS );
            ...
            PositionRotatedEntityOnTag( &flash, &jetpack, jetpack.hModel, "tag_flash" );
            trap_R_AddRefEntityToScene( &flash );
            
            if( IsParticleSystemValid( &cent->jetPackPS ) )
            {
                SetAttachmentTag( &cent->jetPackPS->attachment, jetpack, jetpack.hModel, "tag_flash" );
                SetAttachmentCent( &cent->jetPackPS->attachment, cent );
                AttachToTag( &cent->jetPackPS->attachment );
            }
        }
        else if( IsParticleSystemValid( &cent->jetPackPS ) )
        {
            DestroyParticleSystem( &cent->jetPackPS );
    ...
    if( held & ( 1 << UP_BATTPACK ) )
    {
        ...
        //FIXME: change to tag_back when it exists
        PositionRotatedEntityOnTag( &battpack, torso, torso->hModel, "tag_head" );
    ...
    if( es->eFlags & EF_BLOBLOCKED )
    {
        ...
        Trace( &tr, es->pos.trBase, NULL, NULL, temp, es->number, MASK_SOLID );
        VectorCopy( tr.endpos, origin );
        
        size = 32.0f;
        
        if( size > 0.0f )
            ImpactMark( cgs.media.creepShader, origin, up, 0.0f, 1.0f, 1.0f, 1.0f, 1.0f, false, size, true );
    }
}
...
/*
===============
idCGameLocal::PlayerFloatSprite

Float a sprite over the player's head
===============
*/
void idCGameLocal::PlayerFloatSprite( centity_t* cent, qhandle_t shader )
{
    S32           rf;
    refEntity_t   ent;
...
/*
===============
idCGameLocal::PlayerSprites

Float sprites over the player's head
===============
*/
void idCGameLocal::PlayerSprites( centity_t* cent )
{
...
bool idCGameLocal::PlayerShadow( centity_t* cent, F32* shadowPlane, class_t _class )
{
    ...
    bggame->ClassBoundingBox( _class, mins, maxs, NULL, NULL, NULL );
    mins[ 2 ] = 0.0f;
    maxs[ 2 ] = 2.0f;
    ...
    *shadowPlane = 0;
    ...
    ImpactMark( cgs.media.shadowMarkShader, trace.endpos, trace.plane.normal, cent->pe.legs.yawAngle, 0.0f, 0.0f, 0.0f, alpha, false, 24.0f * bggame->ClassConfig( _class )->shadowScale, true );
...
/*
===============
idCGameLocal::PlayerSplash

Draw a mark at the water surface
===============
*/
void idCGameLocal::PlayerSplash( centity_t* cent, class_t _class )
{
    vec3_t      start, end;
    vec3_t      mins, maxs;
    trace_t     trace;
    ...
    ImpactMark( cgs.media.wakeMarkShader, trace.endpos, trace.plane.normal, cent->pe.legs.yawAngle, 1.0f, 1.0f, 1.0f, 1.0f, false, 32.0f * bggame->ClassConfig( _class )->shadowScale, true );
}
...
=================
*/
S32 idCGameLocal::LightVerts( vec3_t normal, S32 numVerts, polyVert_t* verts )
{
    S32       i, j;
    F32     incoming;
    vec3_t      ambientLight;
...
/*
=================
idCGameLocal::LightFromDirection
=================
*/
S32 idCGameLocal::LightFromDirection( vec3_t point, vec3_t direction )
{
    S32       j;
    F32     incoming;
    vec3_t    ambientLight;
    ...
    if( incoming <= 0 )
    {
        ...
        return ( S32 )( ( F32 )( result[ 0 ] + result[ 1 ] + result[ 2 ] ) / 3.0f );
    }
...
/*
=================
idCGameLocal::AmbientLight
=================
*/
S32 idCGameLocal::AmbientLight( vec3_t point )
{
    vec3_t      ambientLight;
    vec3_t      lightDir;
    vec3_t      directedLight;
...
===============
*/
void idCGameLocal::Player( centity_t* cent )
{
    clientInfo_t*  ci;
    ...
    S32           renderfx;
    bool      shadow = false;
    F32         shadowPlane = 0.0f;
    entityState_t* es = &cent->currentState;
    class_t       _class = ( class_t )( ( es->misc >> 8 ) & 0xFF );
    F32         scale;
    vec3_t        tempAxis[ 3 ], tempAxis2[ 3 ];
    vec3_t        angles;
    S32           held = es->modelindex;
    vec3_t        surfNormal = { 0.0f, 0.0f, 1.0f };
    ...
    if( es->eFlags & EF_WALLCLIMB && !( es->eFlags & EF_DEAD ) && !( cg.intermissionStarted ) )
    {
        ...
        CapTrace( &tr, start, mins, maxs, end, es->number, MASK_PLAYERSOLID );
    ...
    if( !ci->nonsegmented )
    {
        ...
        {
            if( !IsParticleSystemValid( &cent->poisonCloudedPS ) )
                cent->poisonCloudedPS = SpawnNewParticleSystem( cgs.media.poisonCloudedPS );
            SetAttachmentTag( &cent->poisonCloudedPS->attachment, head, head.hModel, "tag_head" );
            SetAttachmentCent( &cent->poisonCloudedPS->attachment, cent );
            AttachToTag( &cent->poisonCloudedPS->attachment );
        }
        else if( IsParticleSystemValid( &cent->poisonCloudedPS ) )
            DestroyParticleSystem( &cent->poisonCloudedPS );
    }
    ...
    if( es->weapon != WP_NONE )
    {
        if( !ci->nonsegmented )
            ...
            AddPlayerWeapon( &legs, NULL, cent );
    }
    ...
    {
        if( IsParticleSystemValid( &cent->muzzlePS ) )
            DestroyParticleSystem( &cent->muzzlePS );
...
===============
*/
void idCGameLocal::Corpse( centity_t* cent )
{
    clientInfo_t*  ci;
    refEntity_t   legs;
    refEntity_t   torso;
    ...
    bggame->ClassBoundingBox( ( class_t )es->clientNum, liveZ, NULL, NULL, deadZ, NULL );
...
/*
===============
idCGameLocal::ResetPlayerEntity

A player just came into view or teleported, so reset all animation info
===============
*/
void idCGameLocal::ResetPlayerEntity( centity_t* cent )
{
...
/*
==================
idCGameLocal::PlayerDisconnect

Player disconnecting
==================
*/
void idCGameLocal::PlayerDisconnect( vec3_t org )
{
    particleSystem_t*  ps;
    
    trap_S_StartSound( org, ENTITYNUM_WORLD, CHAN_AUTO, cgs.media.disconnectSound );
    
    ps = SpawnNewParticleSystem( cgs.media.disconnectPS );
    
    if( IsParticleSystemValid( &ps ) )
    {
        SetAttachmentPoint( &ps->attachment, org );
...
=================
*/
void idCGameLocal::Bleed( vec3_t origin, vec3_t normal, S32 entityNum )
{
    ...
    ps = SpawnNewParticleSystem( bleedPS );
    
    if( IsParticleSystemValid( &ps ) )
    {
        SetAttachmentPoint( &ps->attachment, origin );
        SetAttachmentCent( &ps->attachment, &cg_entities[ entityNum ] );
        AttachToPoint( &ps->attachment );
        
        SetParticleSystemNormal( ps, normal );
    }
}
...
==================
*/
void idCGameLocal::TeamStatusDisplay( centity_t* cent )
{
    entityState_t*   es = &cent->currentState;
    vec3_t          origin;
    class_t         pclass = ( class_t )( ( es->misc >> 8 ) & 0xFF );
    S32             health = cgs.clientinfo[ es->clientNum ].health;
    //S32             credits = cgs.clientinfo[ es->clientNum ].armor;	currently unused
    F32           healthScale = bggame->Class( pclass )->health;
    F32           x, y;
    vec4_t          color;
    trace_t         tr;
    F32           d;
    ...
    if( ( es->legsAnim & ~ANIM_TOGGLEBIT ) == LEGS_WALKCR || ( es->legsAnim & ~ANIM_TOGGLEBIT ) == LEGS_IDLECR )
        bggame->ClassBoundingBox( pclass,  mins, NULL, maxs, NULL, NULL );
    else
        bggame->ClassBoundingBox( pclass,  mins, maxs, NULL, NULL, NULL );
    ...
    for( j = 0; j < 3; j++ )
    {
        ...
        for( i = 0; i < 3; i++ )
        {
            Trace( &tr, trOrigin, NULL, NULL, origin, entNum, MASK_SHOT );
    ...
    if( cg_drawGun.integer && visible &&
            ...
            WorldToScreen( origin, &x, &y ) )
    {
        if( x > 450 && y > 260 )
            visible = false;
    }
    
    healthScale = ( F32 )health / healthScale;
    ...
    if( cent->buildableStatus.visible )
    {
        if( cent->buildableStatus.lastTime + STATUS_FADE_TIME > cg.time )
            color[ 3 ] = transparency * ( ( F32 )( cg.time - cent->buildableStatus.lastTime ) / STATUS_FADE_TIME );
    }
    ...
    {
        if( cent->buildableStatus.lastTime + STATUS_FADE_TIME > cg.time )
            color[ 3 ] = transparency * ( 1.0f - ( F32 )( cg.time - cent->buildableStatus.lastTime ) / STATUS_FADE_TIME );
        else
            return;
    }
    
    if( WorldToScreen( origin, &x, &y ) )
    {
        F32  picH = bs->frameHeight * 0.85;
        F32  picW = bs->frameWidth * 0.3;
        F32  picX = x;
        F32  picY = y;
        F32  scale;
        F32  subH, subY;
        ...
        if( health > 0 )
        {
            ...
            DrawPic( hX, hY, hW, hH, cgs.media.whiteShader );
            trap_R_SetColor( NULL );
        }
        
        if( bs->overlayShader )
        {
            F32 oW = bs->overlayWidth * 0.3f;
            F32 oH = bs->overlayHeight * 0.85f;
            F32 oX = x;
            F32 oY = y;
            ...
            trap_R_SetColor( frameColor );
            DrawPic( oX, oY, oW, oH, bs->overlayShader );
            trap_R_SetColor( NULL );
        }
        ...
        
        {
            ...
            healthPoints = ( S32 )( healthScale * healthMax );
            ...
            DrawField( nX, subY, 4, subH, subH, healthPoints );
        }
        trap_R_SetColor( NULL );
    }
}
...
/*
==================
idCGameLocal::SortDistance
==================
*/
S32 idCGameLocal::SortDistance2( const void* a, const void* b )
{
    centity_t*    aent, *bent;
    F32        adist, bdist;
    
    aent = &cg_entities[ *( S32* )a ];
    bent = &cg_entities[ *( S32* )b ];
...
/*
==================
idCGameLocal::DrawTeamStatus
==================
*/
void idCGameLocal::DrawTeamStatus( void )
{
    S32             i;
    centity_t*       cent;
    entityState_t*   es;
    S32             buildableList[ MAX_ENTITIES_IN_SNAPSHOT ];
    S32             buildables = 0;
    ...
    if( cg_drawTeamStatus.integer )
    {
        ...
        qsort( buildableList, buildables, sizeof( S32 ), SortDistance2 );
        for( i = 0; i < buildables; i++ )
            TeamStatusDisplay( &cg_entities[ buildableList[ i ] ] );
    }
}

centity_t* idCGameLocal::GetPlayerLocation( void )
{
    centity_t*   eloc, *best;
    F32       bestlen, len;
    vec3_t      origin;
