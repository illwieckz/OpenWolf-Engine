...
void PrintContents( S32 contents )
{
    S32 i;
...
// Changes Globals:		-
//===========================================================================
bool AAS_EntityCollision( S32 entnum,
                          vec3_t start, vec3_t boxmins, vec3_t boxmaxs, vec3_t end,
                          S32 contentmask, bsp_trace_t* trace )
{
...
// Changes Globals:		-
//===========================================================================
S32 AAS_BSPEntityInRange( S32 ent )
{
...
void AAS_ParseBSPEntities( void )
{
    ...
    while( PS_ReadToken( script, &token ) )
    {
        ...
        while( PS_ReadToken( script, &token ) )
        {
            ...
            epair->key = ( UTF8* ) GetHunkMemory( strlen( token.string ) + 1 );
            ...
            StripDoubleQuotes( token.string );
            epair->value = ( UTF8* ) GetHunkMemory( strlen( token.string ) + 1 );
...
// Changes Globals:		-
//===========================================================================
S32 AAS_BSPTraceLight( vec3_t start, vec3_t end, vec3_t endpos, S32* red, S32* green, S32* blue )
{
    return 0;
...
S32 AAS_LoadBSPFile( void )
{
    ...
    bspworld.dentdata = ( UTF8* ) GetClearedHunkMemory( bspworld.entdatasize );
