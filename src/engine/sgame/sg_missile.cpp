...
/*
================
idGameLocal::BounceMissile
================
*/
void idGameLocal::BounceMissile( gentity_t* ent, trace_t* trace )
{
    vec3_t  velocity;
    F32 dot;
    S32   hitTime;
...
/*
================
idGameLocal::ExplodeMissile

Explode a missile without an impact
================
*/
void idGameLocal::ExplodeMissile( gentity_t* ent )
{
    vec3_t dir, origin;
    ...
    // splash damage
    if( ent->splashDamage )
        RadiusDamage( ent->r.currentOrigin, ent->parent, ent->splashDamage, ent->splashRadius, ent, ent->splashMethodOfDeath );
...
/*
================
idGameLocal::MissileImpact
================
*/
void idGameLocal::MissileImpact( gentity_t* ent, trace_t* trace )
{
    ...
    else if( !strcmp( ent->classname, "hive" ) )
    {
        ...
        {
            if( !ent->parent )
                Printf( S_COLOR_YELLOW "WARNING: hive entity has no parent in G_MissileImpact\n" );
            else
    ...
    if( other->takedamage )
    {
        ...
        if( ent->damage )
        {
            ...
            Damage( other, ent, attacker, velocity, ent->s.origin, ent->damage, DAMAGE_NO_LOCDAMAGE, ent->methodOfDeath );
        }
    }
    ...
    if( ent->splashDamage )
        RadiusDamage( trace->endpos, ent->parent, ent->splashDamage, ent->splashRadius, other, ent->splashMethodOfDeath );
...
/*
================
idGameLocal::RunMissile
================
*/
void idGameLocal::RunMissile( gentity_t* ent )
{
    vec3_t    origin;
    trace_t   tr;
    S32     passent;
...
/*
=================
idGameLocal::fire_flamer
=================
*/
gentity_t* idGameLocal::fire_flamer( gentity_t* self, vec3_t start, vec3_t dir )
{
    gentity_t* bolt;
    vec3_t    pvel;
...
/*
=================
idGameLocal::fire_blaster
=================
*/
gentity_t* idGameLocal::fire_blaster( gentity_t* self, vec3_t start, vec3_t dir )
{
    gentity_t* bolt;
...
/*
=================
idGameLocal::fire_pulseRifle
=================
*/
gentity_t* idGameLocal::fire_pulseRifle( gentity_t* self, vec3_t start, vec3_t dir )
{
    gentity_t* bolt;
...
/*
=================
idGameLocal::fire_luciferCannon
=================
*/
gentity_t* idGameLocal::fire_luciferCannon( gentity_t* self, vec3_t start, vec3_t dir, S32 damage, S32 radius, S32 speed )
{
    gentity_t* bolt;
    F32 charge;
    ...
    charge = ( F32 )( damage - LCANNON_SECONDARY_DAMAGE ) / LCANNON_DAMAGE;
...
/*
=================
idGameLocal::launch_grenade
=================
*/
gentity_t* idGameLocal::launch_grenade( gentity_t* self, vec3_t start, vec3_t dir )
{
    gentity_t* bolt;
...
/*
================
idGameLocal::AHive_SearchAndDestroy

Adjust the trajectory to point towards the target
================
*/
void idGameLocal::AHive_SearchAndDestroy( gentity_t* self )
{
    vec3_t dir;
    trace_t tr;
    gentity_t* ent;
...
/*
=================
idGameLocal::fire_hive
=================
*/
gentity_t* idGameLocal::fire_hive( gentity_t* self, vec3_t start, vec3_t dir )
{
    gentity_t* bolt;
...
/*
=================
idGameLocal::fire_lockblob
=================
*/
gentity_t* idGameLocal::fire_lockblob( gentity_t* self, vec3_t start, vec3_t dir )
{
    gentity_t* bolt;
...
/*
=================
idGameLocal::fire_slowBlob
=================
*/
gentity_t* idGameLocal::fire_slowBlob( gentity_t* self, vec3_t start, vec3_t dir )
{
    gentity_t* bolt;
...
/*
=================
idGameLocal::fire_bounceBall
=================
*/
gentity_t* idGameLocal::fire_bounceBall( gentity_t* self, vec3_t start, vec3_t dir )
{
    gentity_t* bolt;
