...
UTF8* CON_Input_tty( void );
void CON_Print_tty( StringEntry message );
...
==================
*/
static ID_INLINE void CON_SetColor( WINDOW* win, S32 color )
{
...
==================
*/
static void CON_ColorPrint( WINDOW* win, StringEntry msg, bool stripcodes )
{
...
void CON_Init( void )
{
    ...
    if( curses_on )
    {
        ...
        CON_ColorPrint( inputwin, input_field.buffer + input_field.scroll, false );
    }
    CON_UpdateCursor();
    wnoutrefresh( inputwin );
