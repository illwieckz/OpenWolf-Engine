...
typedef int ( *CODEC_READ )( snd_stream_t* stream, S32 bytes, void* buffer );
...
int             S_CodecReadStream( snd_stream_t* stream, S32 bytes, void* buffer );
...
int             S_OGG_CodecReadStream( snd_stream_t* stream, S32 bytes, void* buffer );
