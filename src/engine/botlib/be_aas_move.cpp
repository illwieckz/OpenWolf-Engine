...
S32 AAS_AgainstLadder( vec3_t origin )
{
    ...
    for( i = 0; i < area->numfaces; i++ )
    {
        ...
        {
            if( AAS_PointInsideFace( fabs( facenum ), origin, 0.1f ) ) return true;
        } //end if
    } //end for
    return false;
...
// Changes Globals:		-
//===========================================================================
F32 AAS_WeaponJumpZVelocity( vec3_t origin, F32 radiusdamage )
{
    vec3_t kvel, v, start, end, forward, right, viewangles, dir;
    F32	mass, knockback, points;
    ...
    VectorNormalize( dir );
    //damage velocity
    VectorScale( dir, 1600.0 * ( F32 )knockback / mass, kvel );	//the rocket jump hack...
...
// Changes Globals:		-
//===========================================================================
void AAS_Accelerate( vec3_t velocity, F32 frametime, vec3_t wishdir, F32 wishspeed, F32 accel )
{
    // q2 style
    S32			i;
...
// Changes Globals:		-
//===========================================================================
void AAS_ApplyFriction( vec3_t vel, F32 friction, F32 stopspeed, F32 frametime )
{
    F32 speed, control, newspeed;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_ClipToBBox( aas_trace_t* trace, vec3_t start, vec3_t end, S32 presencetype, vec3_t mins, vec3_t maxs )
{
    S32 i, j, side;
    F32 front, back, frac, planedist;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_ClientMovementPrediction( struct aas_clientmove_s* move,
                                  S32 entnum, vec3_t origin,
                                  S32 presencetype, S32 onground,
                                  vec3_t velocity, vec3_t cmdmove,
                                  S32 cmdframes,
                                  S32 maxframes, F32 frametime,
                                  S32 stopevent, S32 stopareanum,
                                  vec3_t mins, vec3_t maxs, S32 visualize )
{
    F32 phys_friction, phys_stopspeed, phys_gravity, phys_waterfriction;
    F32 phys_watergravity;
    F32 phys_walkaccelerate, phys_airaccelerate, phys_swimaccelerate;
    F32 phys_maxwalkvelocity, phys_maxcrouchvelocity, phys_maxswimvelocity;
    F32 phys_maxstep, phys_maxsteepness, phys_jumpvel, friction;
    F32 gravity, delta, maxvel, wishspeed, accelerate;
    //F32 velchange, newvel;
    S32 n, i, j, pc, step, swimming, ax, crouch, event, jump_frame, areanum;
    S32 areas[20], numareas;
    vec3_t points[20];
...
// Changes Globals:		-
//===========================================================================
S32 AAS_ClientMovementHitBBox( struct aas_clientmove_s* move,
                               S32 entnum, vec3_t origin,
                               S32 presencetype, S32 onground,
                               vec3_t velocity, vec3_t cmdmove,
                               S32 cmdframes,
...
{
    F32 phys_gravity, phys_maxvelocity;
    F32 maxjump, height2fall, t, top;
    vec3_t dir;
