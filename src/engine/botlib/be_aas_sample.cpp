...
typedef struct aas_tracestack_s
{
    ...
    S32 planenum;		//last plane used as splitter
    S32 nodenum;		//node found after splitting with planenum
} aas_tracestack_t;
...
void AAS_InitAASLinkHeap( void )
{
    ...
    if( !aasworld.linkheap )
    {
        ...
        max_aaslinks = 6144;
#else
        max_aaslinks = ( S32 ) LibVarValue( "max_aaslinks", "6144" );
#endif
...
// Changes Globals:		-
//===========================================================================
S32 AAS_PointReachabilityAreaIndex( vec3_t origin )
{
    S32 areanum, cluster, i, index;
...
// Changes Globals:		-
//===========================================================================
vec_t AAS_BoxOriginDistanceFromPlane( vec3_t normal, vec3_t mins, vec3_t maxs, S32 side )
{
    vec3_t v1, v2;
    S32 i;
...
// Changes Globals:		-
//===========================================================================
bool AAS_AreaEntityCollision( S32 areanum, vec3_t start, vec3_t end,
                              S32 presencetype, S32 passent, aas_trace_t* trace )
{
    S32 collision;
...
// Changes Globals:		-
//===========================================================================
aas_trace_t AAS_TraceClientBBox( vec3_t start, vec3_t end, S32 presencetype,
                                 S32 passent )
{
    S32 side, nodenum, tmpplanenum;
    F32 front, back, frac;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_BoxOnPlaneSide2( vec3_t absmins, vec3_t absmaxs, aas_plane_t* p )
{
    S32 i, sides;
    F32 dist1, dist2;
    vec3_t corners[2];
...
// Changes Globals:		-
//===========================================================================
//S32 AAS_BoxOnPlaneSide(vec3_t absmins, vec3_t absmaxs, aas_plane_t *p)
...
typedef struct
{
    S32 nodenum;		//node found after splitting
} aas_linkstack_t;
