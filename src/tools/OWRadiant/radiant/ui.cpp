...
static void button_press( GtkWidget* widget, GdkEventButton* event, gpointer data )
{
    ...
    {
        case 1:
            pListen->OnLButtonDown( event->state, event->x, event->y );
            break;
        case 3:
            pListen->OnRButtonDown( event->state, event->x, event->y );
            break;
    }
}
...
static void button_release( GtkWidget* widget, GdkEventButton* event, gpointer data )
{
    ...
    {
        case 1:
            pListen->OnLButtonUp( event->state, event->x, event->y );
            break;
        case 3:
            pListen->OnRButtonUp( event->state, event->x, event->y );
            break;
    }
}
