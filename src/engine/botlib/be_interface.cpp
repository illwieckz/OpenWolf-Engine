...
//
// -------------------------------------------------------------------------------------
// File name:   be_interface.cpp
// Version:     v1.00
// Created:
// Compilers:   Visual Studio 2015
// Description: bot library interface
// -------------------------------------------------------------------------------------
////////////////////////////////////////////////////////////////////////////////////////
...
// Changes Globals:		-
//===========================================================================
bool ValidClientNumber( S32 num, UTF8* str )
{
...
// Changes Globals:		-
//===========================================================================
bool ValidEntityNumber( S32 num, UTF8* str )
{
...
// Changes Globals:		-
//===========================================================================
S32 Export_BotLibVarSet( UTF8* var_name, UTF8* value )
{
...
// Changes Globals:		-
//===========================================================================
S32 Export_BotLibVarGet( UTF8* var_name, UTF8* value, S32 size )
{
    UTF8* varvalue;
...
// Changes Globals:		-
//===========================================================================
S32 Export_BotLibStartFrame( F32 time )
{
...
// Changes Globals:		-
//===========================================================================
S32 Export_BotLibLoadMap( StringEntry mapname )
{
#ifdef DEBUG
...
// Changes Globals:		-
//===========================================================================
S32 Export_BotLibUpdateEntity( S32 ent, bot_entitystate_t* state )
{
...
// Changes Globals:		-
//===========================================================================
void AAS_TestMovementPrediction( S32 entnum, vec3_t origin, vec3_t dir );
...
S32 AAS_PointLight( vec3_t origin, S32* red, S32* green, S32* blue );
...
S32 BotExportTest( S32 parm0, UTF8* parm1, vec3_t parm2, vec3_t parm3 )
{
...
//	return AAS_PointLight(parm2, NULL, NULL, NULL);
    ...
    static S32 area = -1;
    static S32 line[2];
    S32 newarea, i, highlightarea, flood;
//	S32 reachnum;
...
//	} //end if*/
    ...
    */
    ...
    {
        static S32 lastgoalareanum, lastareanum;
        static S32 avoidreach[MAX_AVOIDREACH];
        static F32 avoidreachtimes[MAX_AVOIDREACH];
        static S32 avoidreachtries[MAX_AVOIDREACH];
        S32 reachnum, resultFlags;
        bot_goal_t goal;
        aas_reachability_t reach;
