...
public:
    ...
    static cvar_t* FindVar( StringEntry var_name );
    ...
    virtual cvar_t* Get( StringEntry var_name, StringEntry var_value, S32 flags );
    virtual cvar_t* GetSet2( StringEntry var_name, StringEntry value, bool force );
    ...
    virtual void CheckRange( cvar_t* var, F32 min, F32 max, bool integral );
    virtual void Register( vmCvar_t* vmCvar, StringEntry varName, StringEntry defaultValue, S32 flags );
    virtual void Update( vmCvar_t* vmCvar );
