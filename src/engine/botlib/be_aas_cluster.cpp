...
// Changes Globals:		-
//===========================================================================
void AAS_ClearCluster( S32 clusternum )
{
    S32 i;
...
// Changes Globals:		-
//===========================================================================
void AAS_RemovePortalsClusterReference( S32 clusternum )
{
    S32 portalnum;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_UpdatePortal( S32 areanum, S32 clusternum )
{
    S32 portalnum;
    aas_portal_t* portal;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_FloodClusterAreas_r( S32 areanum, S32 clusternum )
{
    aas_area_t* area;
    aas_face_t* face;
    S32 facenum, i;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_FloodClusterAreasUsingReachabilities( S32 clusternum )
{
    S32 i, j, areanum;
...
// Changes Globals:		-
//===========================================================================
void AAS_NumberClusterPortals( S32 clusternum )
{
    S32 i, portalnum;
    aas_cluster_t* cluster;
    aas_portal_t* portal;
...
// Changes Globals:		-
//===========================================================================
void AAS_NumberClusterAreas( S32 clusternum )
{
    S32 i, portalnum;
    aas_cluster_t* cluster;
    aas_portal_t* portal;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_MapContainsTeleporters(void)
{
...
// Changes Globals:		-
//===========================================================================
S32 AAS_NonConvexFaces(aas_face_t *face1, aas_face_t *face2, S32 side1, S32 side2)
{
	S32 i, j, edgenum;
...
// Changes Globals:		-
//===========================================================================
bool AAS_CanMergeAreas(S32 *areanums, S32 numareas)
{
	S32 i, j, s, face1num, face2num, side1, side2, fn1, fn2;
...
// Changes Globals:		-
//===========================================================================
bool AAS_NonConvexEdges(aas_edge_t *edge1, aas_edge_t *edge2, S32 side1, S32 side2, S32 planenum)
{
	S32 i;
...
// Changes Globals:		-
//===========================================================================
bool AAS_CanMergeFaces(S32 *facenums, S32 numfaces, S32 planenum)
{
	S32 i, j, s, edgenum1, edgenum2, side1, side2, en1, en2, ens;
...
// Changes Globals:		-
//===========================================================================
void AAS_ConnectedAreas_r( S32* areanums, S32 numareas, S32* connectedareas, S32 curarea )
{
    S32 i, j, otherareanum, facenum;
    aas_area_t* area;
    aas_face_t* face;
...
// Changes Globals:		-
//===========================================================================
bool AAS_ConnectedAreas( S32* areanums, S32 numareas )
{
    S32 connectedareas[MAX_PORTALAREAS], i;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_GetAdjacentAreasWithLessPresenceTypes_r( S32* areanums, S32 numareas, S32 curareanum )
{
    S32 i, j, presencetype, otherpresencetype, otherareanum, facenum;
    aas_area_t* area;
    aas_face_t* face;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_CheckAreaForPossiblePortals( S32 areanum )
{
    S32 i, j, k, fen, ben, frontedgenum, backedgenum, facenum;
    S32 areanums[MAX_PORTALAREAS], numareas, otherareanum;
    S32 numareafrontfaces[MAX_PORTALAREAS], numareabackfaces[MAX_PORTALAREAS];
    S32 frontfacenums[MAX_PORTALAREAS], backfacenums[MAX_PORTALAREAS];
    S32 numfrontfaces, numbackfaces;
    S32 frontareanums[MAX_PORTALAREAS], backareanums[MAX_PORTALAREAS];
    S32 numfrontareas, numbackareas;
    S32 frontplanenum, backplanenum, faceplanenum;
    aas_area_t* area;
...
// Changes Globals:		-
//===========================================================================
void AAS_FloodCluster_r( S32 areanum, S32 clusternum )
{
    S32 i, otherareanum;
    aas_face_t* face;
    aas_area_t* area;
...
// Changes Globals:		-
//===========================================================================
void AAS_FloodClusterReachabilities( S32 clusternum )
{
    S32 i, j, areanum;
...
{
    S32 i, j, k, facenum, otherareanum, nonclosingportals;
    aas_area_t* area;
    aas_face_t* face;
...
void AAS_RemoveNotClusterClosingPortals( void )
{
    S32 i, j, facenum, otherareanum, nonclosingportals, numseperatedclusters;
    aas_area_t* area;
    aas_face_t* face;
...
{
    S32 j, area2num, facenum, otherareanum;
    UTF8* target, *targetname, *classname;
...
{
    S32 i, removedPortalAreas;
    S32 n, total, numreachabilityareas;
    ...
    if( aasworld.numclusters >= 1 )
    {
        ...
        if( !( ( S32 )LibVarGetValue( "forceclustering" ) ) &&
                !( ( S32 )LibVarGetValue( "forcereachability" ) ) ) return;
#endif
    } //end if
