...
#ifdef BSPC
UTF8 basefolder[MAX_PATH];
#else
UTF8 basefolder[MAX_QPATH];
#endif
...
// Changes Globals:		-
//============================================================================
S32 PS_ReadWhiteSpace( script_t* script )
{
    while( 1 )
    {
        //skip white space
...
// Changes Globals:		-
//============================================================================
S32 PS_ReadEscapeCharacter( script_t* script, UTF8* ch )
{
    S32 c, val, i;
    ...
    switch( *script->script_p )
    {
        ...
        {
            if( *script->script_p < '0' || *script->script_p > '9' ) ScriptError( script, "unknown escape UTF8" );
            for( i = 0, val = 0; ; i++, script->script_p++ )
            {
                c = *script->script_p;
                if( c >= '0' && c <= '9' ) c = c - '0';
...
// Changes Globals:		-
//============================================================================
S32 PS_ReadString( script_t* script, token_t* token, S32 quote )
{
    S32 len, tmpline;
    UTF8* tmpscript_p;
...
// Changes Globals:		-
//============================================================================
S32 PS_ReadName( script_t* script, token_t* token )
{
    S32 len = 0;
    UTF8 c;
...
// Changes Globals:		-
//============================================================================
void NumberValue( UTF8* string, S32 subtype, U64* intvalue, F64* floatvalue )
{
    U64 dotfound = 0;
...
// Changes Globals:		-
//============================================================================
S32 PS_ReadNumber( script_t* script, token_t* token )
{
    S32 len = 0, i;
    S32 octal, dot;
    UTF8 c;
...
// Changes Globals:		-
//============================================================================
S32 PS_ReadLiteral( script_t* script, token_t* token )
{
...
// Changes Globals:		-
//============================================================================
S32 PS_ReadPunctuation( script_t* script, token_t* token )
{
    S32 len;
    UTF8* p;
    punctuation_t* punc;
...
// Changes Globals:		-
//============================================================================
S32 PS_ReadPrimitive( script_t* script, token_t* token )
{
    S32 len;
...
// Changes Globals:		-
//============================================================================
S32 NumLinesCrossed( script_t* script )
{
...
// Changes Globals:		-
//============================================================================
S32 ScriptSkipTo( script_t* script, UTF8* value )
{
    S32 len;
    UTF8 firstchar;
...
// Changes Globals:		-
//============================================================================
script_t* LoadScriptFile( StringEntry filename )
{
#ifdef BOTLIB
    fileHandle_t fp;
