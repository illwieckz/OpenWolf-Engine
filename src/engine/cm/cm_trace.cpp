...
void CM_TraceThroughBrush( traceWork_t* tw, cbrush_t* brush )
{
    ...
    F32           dist, enterFrac, leaveFrac, d1, d2, f, t;
...
==================
*/
void idCollisionModelManagerLocal::TraceModel( trace_t* results, idTraceModel* model, const idVec3& start, const idVec3& end, S32 mask )
{
#ifndef BSPC
...
==================
*/
idTraceModel* idCollisionModelManagerLocal::GetTraceModelForEntity( S32 entityNum )
{
#ifndef BSPC
