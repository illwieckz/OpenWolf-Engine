...
S32 Huff_getBit( U8* fin, S32* offset )
{
    S32             t;
...
void Huff_Decompress( msg_t* mbuf, S32 offset )
{
    S32             ch, cch, i, j, size;
    U8            seq[65536];
    U8*           buffer;
    ...
    for( j = 0; j < cch; j++ )
    {
        ...
        Huff_addRef( &huff, ( U8 ) ch );	/* Increment node */
    }
...
void Huff_Compress( msg_t* mbuf, S32 offset )
{
    S32             i, ch, size;
    U8            seq[65536];
    U8*           buffer;
    ...
    for( i = 0; i < size; i++ )
    {
        ...
        Huff_addRef( &huff, ( U8 ) ch );	/* Do update */
    }
