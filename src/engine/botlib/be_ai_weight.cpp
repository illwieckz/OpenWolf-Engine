...
// Changes Globals:		-
//===========================================================================
S32 ReadValue( source_t* source, F32* value )
{
    token_t token;
...
// Changes Globals:		-
//===========================================================================
S32 ReadFuzzyWeight( source_t* source, fuzzyseperator_t* fs )
{
...
{
    S32 newindent, index, def, founddefault;
    token_t token;
...
weightconfig_t* ReadWeightConfig( UTF8* filename )
{
    ...
    while( PC_ReadToken( source, &token ) )
    {
        if( !strcmp( token.string, "weight" ) )
        {
            ...
            config->weights[config->numweights].name = ( UTF8* ) GetClearedMemory( strlen( token.string ) + 1 );
...
// Changes Globals:		-
//===========================================================================
bool WriteFuzzySeperators_r( FILE* fp, fuzzyseperator_t* fs, S32 indent )
{
...
// Changes Globals:		-
//===========================================================================
F32 FuzzyWeight_r( S32* inventory, fuzzyseperator_t* fs )
{
    F32 scale, w1, w2;
...
// Changes Globals:		-
//===========================================================================
F32 FuzzyWeightUndecided_r( S32* inventory, fuzzyseperator_t* fs )
{
    F32 scale, w1, w2;
...
// Changes Globals:		-
//===========================================================================
void ScaleFuzzySeperator_r( fuzzyseperator_t* fs, F32 scale )
{
    if( fs->child )
    {
...
// Changes Globals:		-
//===========================================================================
void ScaleFuzzySeperatorBalanceRange_r( fuzzyseperator_t* fs, F32 scale )
{
    if( fs->child )
    {
    ...
    {
        F32 mid = ( fs->minweight + fs->maxweight ) * 0.5;
        //get the weight between bounds
...
// Changes Globals:		-
//===========================================================================
void ScaleFuzzyBalanceRange( weightconfig_t* config, F32 scale )
{
    S32 i;
...
// Changes Globals:		-
//===========================================================================
S32 InterbreedFuzzySeperator_r( fuzzyseperator_t* fs1, fuzzyseperator_t* fs2,
