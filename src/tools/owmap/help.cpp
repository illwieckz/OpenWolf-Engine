...
void HelpBsp()
{
    struct HelpOption bsp[] =
    {
        ...
        {"-bspfile <filename.world>", "BSP file to write"},
...
void HelpLight()
{
    struct HelpOption light[] =
    {
        ...
        {"-bspfile <filename.world>", "BSP file to read and write"},
...
void HelpExport()
{
    ...
    {
        {"-export <filename.world>", "Copies lightmaps from the BSP to `filename/lightmap_0000.tga`"}
    };
...
void HelpImport()
{
    ...
    {
        {"-import <filename.world>", "Copies lightmaps from `filename/lightmap_0000.tga` into the BSP"},
    };
...
void HelpMinimap()
{
    ...
    {
        {"-minimap <filename.world>", "Creates a minimap of the BSP, by default writes to `mapname.tga`"},
