...
public:
    ...
    virtual cvar_t* Get( StringEntry var_name, StringEntry var_value, S32 flags ) = 0;
    virtual cvar_t* GetSet2( StringEntry var_name, StringEntry value, bool force ) = 0;
    ...
    virtual void CheckRange( cvar_t* var, F32 min, F32 max, bool integral ) = 0;
    virtual void Register( vmCvar_t* vmCvar, StringEntry varName, StringEntry defaultValue, S32 flags ) = 0;
    virtual void Update( vmCvar_t* vmCvar ) = 0;
