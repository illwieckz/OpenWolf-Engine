...
==============
*/
bool idFileSystemLocal::Initialized()
{
...
void idFileSystemLocal::TouchFile_f( void )
{
    ...
    fileSystemLocal.FOpenFileRead( Cmd_Argv( 1 ), &f, false );
...
void idFileSystemLocal::Startup( StringEntry gameName )
{
    ...
    fs_basepath = cvarSystem->Get( "fs_basepath", Sys_DefaultInstallPath(), CVAR_INIT );
    ...
    fs_libpath = cvarSystem->Get( "fs_libpath", Sys_DefaultLibPath(), CVAR_INIT );
#ifdef MACOS_X
    fs_apppath = cvarSystem->Get( "fs_apppath", Sys_DefaultAppPath(), CVAR_INIT );
#endif
    ...
    Cmd_AddCommand( "fdir", NewDir_f );
    Cmd_AddCommand( "touchFile", TouchFile_f );
    Cmd_AddCommand( "which", Which_f );
