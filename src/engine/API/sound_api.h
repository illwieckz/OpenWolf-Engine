...
public:
    ...
    virtual void RawSamples( S32 stream, S32 samples, S32 rate, S32 width, S32 channels, const U8* data, F32 volume ) = 0;
    ...
    virtual sfxHandle_t RegisterSound( StringEntry sample ) = 0;
