...
===============
*/
static ID_INLINE void WRITE_STRING( StringEntry s )
{
...
===============
*/
static ID_INLINE void WRITE_4BYTES( S32 x )
{
...
===============
*/
static ID_INLINE void WRITE_2BYTES( S32 x )
{
    buffer[bufIndex + 0] = ( U8 )( ( x >> 0 ) & 0xFF );
    buffer[bufIndex + 1] = ( U8 )( ( x >> 8 ) & 0xFF );
    bufIndex += 2;
...
===============
*/
static ID_INLINE void WRITE_1BYTES( S32 x )
{
    buffer[bufIndex] = x;
    bufIndex += 1;
}
...
===============
*/
static ID_INLINE void START_CHUNK( StringEntry s )
{
...
===============
*/
bool CL_OpenAVIForWriting( StringEntry fileName )
{
    if( afd.fileOpen )
        return false;
...
===============
*/
static bool CL_CheckFileSize( S32 bytesToAdd )
{
    U32    newFileSize;
...
===============
*/
void CL_WriteAVIAudioFrame( const U8* pcmBuffer, S32 size )
{
