...
=================
*/
F32 UI_ClampCvar( F32 min, F32 max, F32 value )
{
...
{
    static UTF8 buffer[ MAX_SAY_TEXT ];
    itemDef_t* item;
    if( trap_Argc( ) < 3 )
    {
...
=================
*/
bool idUserInterfaceManagerLocal::ConsoleCommand( S32 realTime )
{
    UTF8*  cmd;
    S32   i;
...
void UI_DrawNamedPic( F32 x, F32 y, F32 width, F32 height, StringEntry picname )
{
    qhandle_t  hShader;
