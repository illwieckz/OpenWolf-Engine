...
#ifdef ZONE_DEBUG
void*           Z_TagMallocDebug( S32 size, S32 tag, UTF8* label, UTF8* file, S32 line )
{
#else
void*           Z_TagMalloc( S32 size, S32 tag )
{
#endif
    S32             extra, allocSize;
...
*/
#ifdef ZONE_DEBUG
void*           Z_MallocDebug( S32 size, UTF8* label, UTF8* file, S32 line )
{
#else
...
#ifdef ZONE_DEBUG
void*           S_MallocDebug( S32 size, UTF8* label, UTF8* file, S32 line )
{
    return Z_TagMallocDebug( size, TAG_SMALL, label, file, line );
}
#else
void*           S_Malloc( S32 size )
{
...
static StringEntry completionString;
...
void Field_CompleteCommand( UTF8* cmd, bool doCommands, bool doCvars )
{
    ...
    {
        StringEntry baseCmd = Cmd_Argv( 0 );
        UTF8* p;
