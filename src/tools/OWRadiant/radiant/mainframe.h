...
#ifdef _WIN32
    const GdkRectangle& GetPrimaryMonitorRect( void ) const
    {
        return primaryMonitorRect;
    }
    const int GetGDKOffsetX( void ) const
    {
        return gdk_offset_x;
    }
    const int GetGDKOffsetY( void ) const
    {
        return gdk_offset_y;
    }
#endif
...
public:
    ...
    CSynapseServer& GetSynapseServer()
    {
        return m_SynapseServer;
    };
    CSynapseClientRadiant& GetSynapseClient()
    {
        return m_SynapseClient;
    };
