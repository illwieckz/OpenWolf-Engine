...
static S32 numtokens;
/*
S32 tokenheapinitialized;				//true when the token heap is initialized
...
// Changes Globals:		-
//============================================================================
void PC_PushIndent( source_t* source, S32 type, S32 skip )
{
    indent_t* indent;
...
// Changes Globals:		-
//============================================================================
void PC_PopIndent( source_t* source, S32* type, S32* skip )
{
    indent_t* indent;
...
// Changes Globals:		-
//============================================================================
S32 PC_ReadSourceToken( source_t* source, token_t* token )
{
    token_t* t;
    script_t* script;
    S32 type, skip;
...
// Changes Globals:		-
//============================================================================
S32 PC_UnreadSourceToken( source_t* source, token_t* token )
{
    token_t* t;
...
// Changes Globals:		-
//============================================================================
S32 PC_ReadDefineParms( source_t* source, define_t* define, token_t** parms, S32 maxparms )
{
...
// Changes Globals:		-
//============================================================================
S32 PC_StringizeTokens( token_t* tokens, token_t* token )
{
    token_t* t;
...
// Changes Globals:		-
//============================================================================
S32 PC_MergeTokens( token_t* t1, token_t* t2 )
{
...
// Changes Globals:		-
//============================================================================
define_t* PC_FindHashedDefine( define_t** definehash, UTF8* name )
{
    define_t* d;
    S32 hash;
...
// Changes Globals:		-
//============================================================================
define_t* PC_FindDefine( define_t* defines, UTF8* name )
{
    define_t* d;
...
// Changes Globals:		-
//============================================================================
S32 PC_FindDefineParm( define_t* define, UTF8* name )
{
    token_t* p;
    S32 i;
...
// Changes Globals:		-
//============================================================================
S32 PC_ExpandBuiltinDefine( source_t* source, token_t* deftoken, define_t* define,
...
// Changes Globals:		-
//============================================================================
S32 PC_ExpandDefine( source_t* source, token_t* deftoken, define_t* define,
                     token_t** firsttoken, token_t** lasttoken )
{
...
// Changes Globals:		-
//============================================================================
S32 PC_ExpandDefineIntoSource( source_t* source, token_t* deftoken, define_t* define )
{
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_include( source_t* source )
{
    script_t* script;
    token_t token;
    UTF8 path[MAX_PATH];
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_undef( source_t* source )
{
    token_t token;
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_define( source_t* source )
{
    token_t token, *t, *last;
    define_t* define;
...
// Changes Globals:		-
//============================================================================
define_t* PC_DefineFromString( UTF8* string )
{
    script_t* script;
    source_t src;
    token_t* t;
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_if_def( source_t* source, S32 type )
{
    token_t token;
    define_t* d;
    S32 skip;
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_ifdef( source_t* source )
{
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_ifndef( source_t* source )
{
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_else( source_t* source )
{
    S32 type, skip;
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_endif( source_t* source )
{
    S32 type, skip;
...
S32 PC_OperatorPriority( S32 op )
{
    switch( op )
    {
        case P_MUL:
...
S32 PC_EvaluateTokens( source_t* source, token_t* tokens, S64* intvalue, F64* floatvalue, S32 integer )
{
...
// Changes Globals:		-
//============================================================================
S32 PC_Evaluate( source_t* source, S64* intvalue, F64* floatvalue, S32 integer )
{
...
// Changes Globals:		-
//============================================================================
S32 PC_DollarEvaluate( source_t* source, S64* intvalue, F64* floatvalue, S32 integer )
{
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_elif( source_t* source )
{
    S64 value;
    S32 type, skip;
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_if( source_t* source )
{
    S64 value;
    S32 skip;
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_line( source_t* source )
{
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_error( source_t* source )
{
    token_t token;
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_pragma( source_t* source )
{
    token_t token;
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_eval( source_t* source )
{
    S64 value;
    token_t token;
...
// Changes Globals:		-
//============================================================================
S32 PC_Directive_evalfloat( source_t* source )
{
    F64 value;
    token_t token;
...
S32 PC_ReadDirective( source_t* source )
{
    token_t token;
    S32 i;
...
// Changes Globals:		-
//============================================================================
S32 PC_DollarDirective_evalint( source_t* source )
{
    S64 value;
    token_t token;
...
// Changes Globals:		-
//============================================================================
S32 PC_DollarDirective_evalfloat( source_t* source )
{
    F64 value;
    token_t token;
...
S32 PC_ReadDollarDirective( source_t* source )
{
    token_t token;
    S32 i;
...
// Changes Globals:		-
//============================================================================
S32 BuiltinFunction( source_t* source )
{
    token_t token;
...
// Changes Globals:		-
//============================================================================
S32 QuakeCMacro( source_t* source )
{
    S32 i;
    token_t token;
