...
==============
*/
void idCGameLocal::DamageFeedback( S32 yawByte, S32 pitchByte, S32 damage )
{
    F32   left, front, up;
    F32   kick;
    S32     health;
...
================
*/
void idCGameLocal::Respawn( void )
{
...
==============
*/
void idCGameLocal::CheckPlayerstateEvents( playerState_t* ps, playerState_t* ops )
{
    S32       i;
    S32       event;
    centity_t* cent;
...
==================
*/
void idCGameLocal::CheckChangedPredictableEvents( playerState_t* ps )
{
    S32       i;
    S32       event;
    centity_t* cent;
...
==================
*/
void idCGameLocal::CheckLocalSounds( playerState_t* ps, playerState_t* ops )
{
    S32 reward;
    ...
    if( ps->stats[ STAT_HEALTH ] < ops->stats[ STAT_HEALTH ] - 1 )
    {
        if( ps->stats[ STAT_HEALTH ] > 0 )
            PainEvent( &cg.predictedPlayerEntity, ps->stats[ STAT_HEALTH ] );
    }
...
===============
*/
void idCGameLocal::TransitionPlayerState( playerState_t* ps, playerState_t* ops )
{
