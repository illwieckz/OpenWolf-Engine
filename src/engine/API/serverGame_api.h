...
public:
    ...
    virtual void BotGetUserCommand( S32 clientNum, usercmd_t* ucmd ) = 0;
    virtual void PhysicsSetGravity( const idVec3& gravity ) = 0;
    virtual idTraceModel* AllocTraceModel( void ) = 0;
