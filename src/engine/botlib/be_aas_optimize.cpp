...
typedef struct optimized_s
{
    ...
    aas_area_t* areas;
    //
    S32* vertexoptimizeindex;
    S32* edgeoptimizeindex;
    S32* faceoptimizeindex;
} optimized_t;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_KeepEdge( aas_edge_t* edge )
{
    return 1;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_OptimizeEdge( optimized_t* optimized, S32 edgenum )
{
    S32 i, optedgenum;
...
// Changes Globals:		-
//===========================================================================
S32 AAS_KeepFace( aas_face_t* face )
{
...
// Changes Globals:		-
//===========================================================================
S32 AAS_OptimizeFace( optimized_t* optimized, S32 facenum )
{
    S32 i, edgenum, optedgenum, optfacenum;
...
// Changes Globals:		-
//===========================================================================
void AAS_OptimizeArea( optimized_t* optimized, S32 areanum )
{
    S32 i, facenum, optfacenum;
...
void AAS_OptimizeAlloc( optimized_t* optimized )
{
    ...
    //
    optimized->vertexoptimizeindex = ( S32* ) GetClearedMemory( aasworld.numvertexes * sizeof( S32 ) );
    optimized->edgeoptimizeindex = ( S32* ) GetClearedMemory( aasworld.numedges * sizeof( S32 ) );
    optimized->faceoptimizeindex = ( S32* ) GetClearedMemory( aasworld.numfaces * sizeof( S32 ) );
